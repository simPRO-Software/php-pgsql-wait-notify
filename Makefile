srcdir = /root/server/php-pgsql-5.6
builddir = /root/server/php-pgsql-5.6
top_srcdir = /root/server/php-pgsql-5.6
top_builddir = /root/server/php-pgsql-5.6
...
RE2C = exit 0;
AWK = nawk
PGSQL_SHARED_LIBADD = -Wl,-rpath,/usr/local/lib -L/usr/local/lib -lpq
shared_objects_pgsql = pgsql.lo
PHP_PECL_EXTENSION = pgsql
PHP_MODULES = $(phplibdir)/pgsql.la
PHP_ZEND_EX =
...
prefix = /usr/local
phplibdir = /root/server/php-pgsql-5.6/modules
